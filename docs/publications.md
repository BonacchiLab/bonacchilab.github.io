...
A modular architecture for organizing, processing and sharing neurophysiology data. **Nature Methods**.  
...
An olfactory self-test effectively screens for COVID-19. **Communications Medicine**, *2*(1).  
